...
export const skillCategories: SkillCategory[] = [
  {
    ...
    icon: 'code',
    skills: [
      { name: 'HTML5 & Semantic Markup', level: 98, years: 15, note: 'Accessibility-first structure' },
      ...
      { name: 'Responsive & Fluid Design', level: 97, years: 15 },
  ...
  },
  {
    ...
    icon: 'wordpress',
    skills: [
      { name: 'Custom Theme Development', level: 95, years: 13 },
      { name: 'Plugin Development', level: 84, years: 9 },
  ...
  },
  {
    ...
    icon: 'layers',
    skills: [
      { name: 'PHP (WordPress context)', level: 82, years: 12 },
